...
<div class="border-t border-[#30363d] bg-[#161b22] px-2.5 pt-2 pb-2.5 flex flex-col gap-2">
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center gap-1.5">
      ...
      <button
        type="button"
        class="h-7 w-7 rounded-md bg-[#1f2937] text-[#9fb3c8] hover:bg-[#263446] hover:text-[#c9d1d9] disabled:opacity-45 disabled:cursor-not-allowed transition-colors border border-[#30363d] shadow-sm inline-flex items-center justify-center"
  ...
  <div class="mt-1 px-1 pb-1 flex items-center justify-between gap-2">
    ...
    <button
      class="h-8 px-3 rounded-md bg-[#238636] text-white text-xs font-semibold hover:bg-[#2ea043] disabled:opacity-50 disabled:cursor-not-allowed transition-colors border border-[rgba(240,246,252,0.12)] shadow-sm flex items-center justify-center gap-2"
      disabled={!canCommit}
