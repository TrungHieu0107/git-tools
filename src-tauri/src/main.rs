...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cmd_set_show_ignored_files,
            commands::cmd_set_gemini_api_token,
            commands::cmd_set_gemini_model,
            commands::cmd_get_gemini_models,
            commands::cmd_set_open_router_api_token,
            commands::cmd_set_open_router_model,
            commands::cmd_set_active_ai_provider,
            commands::cmd_get_open_router_models,
